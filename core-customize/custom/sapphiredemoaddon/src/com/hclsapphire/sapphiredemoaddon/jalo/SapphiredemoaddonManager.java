 ...
 */
package com.hclsapphire.sapphiredemoaddon.jalo;
...
import com.hclsapphire.sapphiredemoaddon.constants.SapphiredemoaddonConstants;



/**
 * This is the extension manager of the Sapphiredemoaddon extension.
 */
public class SapphiredemoaddonManager extends GeneratedSapphiredemoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapphiredemoaddonManager.class.getName());
	 ...
	 */
	public static SapphiredemoaddonManager getInstance()
	{
		return (SapphiredemoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapphiredemoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapphiredemoaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapphiredemoaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapphiredemoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapphiredemoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
