...
public class AccountPageController extends AbstractSearchPageController
{
	...
	@Resource(name = "sapphireOrderCancelFacade")
	private SapphireOrderCancelFacade sapphireOrderCancelFacade;
	...
	{
		final OrderData orderDetails = orderFacade.getOrderDetailsForCode(orderCode);
		final OrdercancelResultData cancelResult = sapphireOrderCancelFacade.cancelOrder(orderDetails);
		redirectAttributes.addFlashAttribute("orderCancelResult", cancelResult);
		return REDIRECT_TO_ORDERS;
	}

	public SapphireOrderCancelFacade getSapphireOrderCancelFacade()
	{
		return sapphireOrderCancelFacade;
	}

	public void setSapphireOrderCancelFacade(final SapphireOrderCancelFacade sapphireOrderCancelFacade)
	{
		this.sapphireOrderCancelFacade = sapphireOrderCancelFacade;
	}
