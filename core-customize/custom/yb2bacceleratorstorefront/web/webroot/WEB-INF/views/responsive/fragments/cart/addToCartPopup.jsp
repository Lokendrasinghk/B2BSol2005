...
"addToCartLayer":"<spring:escapeBody javaScriptEscape="true" htmlEscape="false">
	...
	<ycommerce:testId code="addToCartPopup">
		<div id="addToCartLayer" class="add-to-cart add-to-cart-popup">
          ...
          <c:choose>
                <c:when test="${parentEquipment ne null}">
                 <p>Parent Equipment ID:  <c:out value="${parentEquipment}" /></p>
                </c:when>
 			</c:choose>

            <a href="" class="btn btn-default btn-block custom-black-outline js-mini-cart-close-button">
