...
<div class="checkout-success">
	<div class="checkout-success__body">
		...
		<p>
		<span>Need Help?</span>
		<c:url value="/showBookAnAppointmentPage?oid=${orderData.code}&custemail=${email}" var="bookAnAppointmentUrl" />
		<a href="${bookAnAppointmentUrl}" class="btn btn-success">GET SUPPORT FROM HELP DESK</a>
		</p>
	</div>
