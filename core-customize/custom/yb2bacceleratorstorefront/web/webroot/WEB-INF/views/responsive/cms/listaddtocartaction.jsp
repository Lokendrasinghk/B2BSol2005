            ...
            <c:choose>
                <c:when test="${product.stock.stockLevelStatus.code eq 'outOfStock' }">
					<c:if test="${not empty product.price.value}">
						<button type="submit" class="btn btn-primary custom-black-outline" aria-disabled="true" disabled="disabled">Add to cart</button>
						<!-- <button type="submit" class="btn btn-primary custom-black-outline btn-block glyphicon glyphicon-shopping-cart"
								aria-disabled="true" disabled="disabled">Add to Cart</button> -->
					</c:if>
                </c:when>				
                <c:otherwise>
                <button type="submit" class="btn btn-primary custom-black-outline js-enable-btn" disabled="disabled">Add to cart</button>
