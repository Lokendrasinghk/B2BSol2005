...
<spring:url value="/my-account/orders" var="orderHistoryLink" htmlEscape="false"/>
...
<template:page pageTitle="${pageTitle}">
    ...
    <div class="account-section">
        <div class="account-section-header no-border">
            <spring:theme code="import.csv.bulkOrder.title"/>
            <div class="account-section-header__subheadline"><spring:theme code="import.csv.bulkOrder.filesNote"/></div>
        </div>
        <div class="account-section-content import-csv__content">
        <div class="row">
        <div class="col-md-6">
            <form:form modelAttribute="importCSVSavedCartForm" enctype="multipart/form-data" method="post" action="${importCSVSavedCartLink}">
            ...
            <formElement:formSelectBox idKey="costCenterSelect" labelKey="checkout.multi.costCenter.label" path="costCenterId" skipBlank="false" skipBlankMessageKey="checkout.multi.costCenter.title.pleaseSelect" itemValue="code" itemLabel="code" items="${costCenters}" mandatory="true" selectCSSClass="form-control"/>
           </form:form>
           </div>
           </div>
    ...
    <span id="import-csv-success-message"><spring:theme code="import.csv.bulkOrder.success" arguments="${orderHistoryLink}" htmlEscape="false"/></span>
