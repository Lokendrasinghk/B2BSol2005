		...
		<div class="carousel-component">
			...
			<div class="carousel js-owl-carousel js-owl-lazy-reference js-owl-carousel-reference">
				...
				<c:forEach end="${component.maximumNumberProducts}" items="${productReferences}" var="productReference">
					<c:url value="${productReference.target.url}/quickView?parentCode=${fn:escapeXml(product.code)}" var="productUrl"/>
					<div class="item">
						<a href="${productUrl}" class="js-reference-item" data-quickview-title="<spring:theme code="popup.quick.view.select"/></span>">
                            ...
                            <c:if test="${productReference.target.price != null || not empty productReference.target.price}">
								<p class="glyphicon glyphicon-shopping-cart new-cart"><span>Buy now</span></p>
							</c:if>
