...
<div class="quick-view-popup">
	...
	<div class="addtocart-component">
		...
		<input type="hidden" name="parentEquipmentCode" value="${parentCode}"/>
		<c:if test="${empty quickViewShowAddToCart ? true : quickViewShowAddToCart}">
			...
			<c:choose>
				<c:when test="${fn:contains(buttonType, 'button')}">
					<button type="${buttonType}" class="btn btn-primary btn-block js-add-to-cart custom-black-outline outOfStock" disabled="disabled">
						<spring:theme code="product.variants.out.of.stock"/>
					</button>
				</c:when>
				<c:otherwise>
					<button id="addToCartButton" type="${buttonType}" class="btn btn-primary btn-block js-add-to-cart js-enable-btn custom-black-outline" disabled="disabled">
		...
		<c:if test="${empty quickViewShowAddToCart ? false : quickViewShowAddToCart and product.availableForPickup}">
