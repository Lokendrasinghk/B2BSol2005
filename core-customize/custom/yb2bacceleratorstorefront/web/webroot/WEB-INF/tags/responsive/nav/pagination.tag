        ...
        <div class="pagination-toolbar">
            <c:if test="${not empty searchPageData.sorts}">
                ...
                <div class="sort-refine-bar">
                   ...
                   <c:if test="${searchPageData.getClass().name == 'de.hybris.platform.commerceservices.search.facetdata.ProductCategorySearchPageData'}">
                   	<div class="col-sm-7 filter-list">
                    	<nav:facetNavAppliedFilters pageData="${searchPageData}"/>
                    </div>
                    	</c:if>
                    
                    <div class="col-xs-12 col-sm-2 col-sm-offset-1 pagination-wrap">
                    ...
                    <div class="pagination-bar-results">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-2 sort-by">
