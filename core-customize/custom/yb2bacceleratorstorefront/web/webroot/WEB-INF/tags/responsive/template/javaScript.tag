...
<c:choose>
	...
	<c:otherwise>
		...
		<!-- below has been commented as slider was not working and replaced -->
		...
		<!-- addedd as part of customizatio- START -->
		<script type="text/javascript" src="${commonResourcePath}/js/moment.js"></script>
		<script type="text/javascript" src="${commonResourcePath}/js/bootstrap-datetimepicker.min.js"></script>
        <script type="text/javascript" src="${commonResourcePath}/js/custom-script.js"></script>
		<script type="text/javascript" src="${commonResourcePath}/js/jquery.zoomtoo.js"></script>
		<!-- addedd as part of customizatio- END -->
