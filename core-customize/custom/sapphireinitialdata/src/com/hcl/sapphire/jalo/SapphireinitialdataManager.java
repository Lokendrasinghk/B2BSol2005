 ...
 */
public class SapphireinitialdataManager extends GeneratedSapphireinitialdataManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(SapphireinitialdataManager.class.getName());
	 ...
	 */
	public static SapphireinitialdataManager getInstance()
	{
		return (SapphireinitialdataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapphireinitialdataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapphireinitialdataManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapphireinitialdataManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapphireinitialdataManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapphireinitialdataManager called, current tenant: " + getTenant().getTenantID());
		}
	}
