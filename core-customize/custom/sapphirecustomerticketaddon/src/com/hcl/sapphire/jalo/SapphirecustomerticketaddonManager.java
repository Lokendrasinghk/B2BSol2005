...
/**
 * This is the extension manager of the Sapphirecustomerticketaddon extension.
 */
public class SapphirecustomerticketaddonManager extends GeneratedSapphirecustomerticketaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapphirecustomerticketaddonManager.class.getName());
	 ...
	 */
	public static SapphirecustomerticketaddonManager getInstance()
	{
		return (SapphirecustomerticketaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapphirecustomerticketaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapphirecustomerticketaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapphirecustomerticketaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapphirecustomerticketaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapphirecustomerticketaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
