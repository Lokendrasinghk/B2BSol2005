 ...
 *
 */
package de.hybris.platform.b2b.occ.v2.controllers.jalo;
...
import de.hybris.platform.b2b.occ.v2.controllers.constants.Demob2boccaddonConstants;



/**
 * This is the extension manager of the demob2boccaddon extension.
 */
public class Demob2boccaddonManager extends GeneratedDemob2boccaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Demob2boccaddonManager.class.getName());
	 ...
	 */
	public Demob2boccaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Demob2boccaddonManager called.");
		}
	}
	 ...
	 */
	public static Demob2boccaddonManager getInstance()
	{
		return (Demob2boccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Demob2boccaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Demob2boccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Demob2boccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
