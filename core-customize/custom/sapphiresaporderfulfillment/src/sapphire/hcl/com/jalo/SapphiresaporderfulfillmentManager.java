...
/**
 * This is the extension manager of the Sapphiresaporderfulfillment extension.
 */
public class SapphiresaporderfulfillmentManager extends GeneratedSapphiresaporderfulfillmentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapphiresaporderfulfillmentManager.class.getName());
	 ...
	 */
	public static SapphiresaporderfulfillmentManager getInstance()
	{
		return (SapphiresaporderfulfillmentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapphiresaporderfulfillmentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapphiresaporderfulfillmentManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapphiresaporderfulfillmentManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapphiresaporderfulfillmentManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapphiresaporderfulfillmentManager called, current tenant: " + getTenant().getTenantID());
		}
	}
