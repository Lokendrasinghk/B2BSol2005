...
/**
 * This is the extension manager of the Sapphiredemocore extension.
 */
public class SapphiredemocoreManager extends GeneratedSapphiredemocoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapphiredemocoreManager.class);
	 ...
	 */
	public static SapphiredemocoreManager getInstance()
	{
		return (SapphiredemocoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapphiredemocoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapphiredemocoreManager() // NOPMD 
	{
		LOG.debug("constructor of SapphiredemocoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapphiredemocoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapphiredemocoreManager called, current tenant: {}", getTenant().getTenantID());
	}
