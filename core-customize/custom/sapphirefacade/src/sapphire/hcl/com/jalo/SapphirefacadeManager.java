...
/**
 * This is the extension manager of the Sapphirefacade extension.
 */
public class SapphirefacadeManager extends GeneratedSapphirefacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapphirefacadeManager.class);
	 ...
	 */
	public static SapphirefacadeManager getInstance()
	{
		return (SapphirefacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapphirefacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapphirefacadeManager() // NOPMD 
	{
		LOG.debug("constructor of SapphirefacadeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapphirefacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapphirefacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
