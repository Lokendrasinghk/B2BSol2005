 ...
 */
package de.hybris.platform.democustomerticketingc4cb2bintegration.jalo;
...
/**
 * This is the extension manager of the Democustomerticketingc4cb2bintegration extension.
 */
public class Democustomerticketingc4cb2bintegrationManager extends GeneratedDemocustomerticketingc4cb2bintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Democustomerticketingc4cb2bintegrationManager.class);
	 ...
	 */
	public static Democustomerticketingc4cb2bintegrationManager getInstance()
	{
		return (Democustomerticketingc4cb2bintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Democustomerticketingc4cb2bintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Democustomerticketingc4cb2bintegrationManager() // NOPMD 
	{
		LOG.debug("constructor of Democustomerticketingc4cb2bintegrationManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Democustomerticketingc4cb2bintegrationManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Democustomerticketingc4cb2bintegrationManager called, current tenant: {}", getTenant().getTenantID());
	}
